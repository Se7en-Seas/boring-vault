...
/**
 *  source .env && forge script script/ArchitectureDeployments/DeployLiquidUsd.s.sol:DeployLiquidUsdScript --with-gas-price 30000000000 --slow --broadcast --etherscan-api-key $ETHERSCAN_KEY --verify
