...
/**
 *  source .env && forge script script/ArchitectureDeployments/Mantle/DeploySkyFallVault.s.sol:DeploySkyFallVaultScript --evm-version london --broadcast --etherscan-api-key $MANTLESCAN_KEY --verify
