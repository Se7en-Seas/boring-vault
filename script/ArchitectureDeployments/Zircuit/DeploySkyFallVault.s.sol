...
/**
 *  source .env && forge script script/ArchitectureDeployments/Zircuit/DeploySkyFallVault.s.sol:DeploySkyFallVaultScript --evm-version london --broadcast
...
contract DeploySkyFallVaultScript is DeployArcticArchitectureManagementOnly, MerkleTreeHelper {
    ...
    function run() external {
        ...
        _deploy(
            "Zircuit/SkyFallDeployment.json",
            owner,
            boringVaultName,
            boringVaultSymbol,
            boringVaultDecimals,
